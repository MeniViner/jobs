...
import { 
  Box, Typography, Button, Avatar, IconButton, Dialog, DialogTitle, DialogContent, DialogActions, TextField, LinearProgress, Card, CardContent, Paper, Snackbar, Alert 
} from '@mui/material';
import { 
  Edit as EditIcon,
...
const EmployerProfile = ({ profileData, onUpdateProfile, onDeleteAccountRequest, handleSignOut, snackbar, setSnackbar }) => {
  ...
  const calculateCompletionPercentage = (data) => {
    const fields = ['name', 'email', 'phone', 'location', 'employerDetails.companyName', 'employerDetails.companyDescription', 'employerDetails.businessType'];
